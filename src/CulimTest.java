...
public class CulimTest
{
    ...
    public static void main(String[] args)
    {
        ...
        String culimController = "culim.Agent";
        ...
        String recordActionsFile = String.format("%s-%s-%s.txt", 
        		culimController.replace(".Agent", ""), gameIdx, levelIdx ); //where to record the actions executed. null if not to save.

        // 1. This starts a game, in a level, played by a human.
//        ArcadeMachine.playOneGame(game, level1, recordActionsFile, seed);

        // 2. This plays a game in a level by the controller.
//        ArcadeMachine.runOneGame(game, level1, true, culimController, recordActionsFile, seed);
...
//            }
//            ArcadeMachine.runGames(game, levels, M, culimController, saveActions? actionFiles:null, seed);
//        }
    }
}
